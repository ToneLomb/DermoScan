...
X_train = X_train.reshape(X_train.shape[0],IMG_SIZE,IMG_SIZE,3) / 255
X_valid = X_valid.reshape(X_valid.shape[0],IMG_SIZE,IMG_SIZE,3) / 255
X_test = X_test.reshape(X_test.shape[0],IMG_SIZE,IMG_SIZE,3) / 255
